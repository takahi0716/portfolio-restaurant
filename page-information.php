...
<main>
  ...
  <section class="sub-mv">
    <picture class="sub-mv__image">
      ...
      <source srcset="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/information-sp.jpg" media="(max-width: 767px)" />
      ...
      <div class="information-sub__content">
        ...
        <div class="information-sub__container">
          ...
          <div class="information-sub__item information-item js-tab-target" data-tab="tab03">
            ...
            <div class="information-item__image">
              <img src="<?php echo get_theme_file_uri(); ?>/dist/assets/images/common/breakfast.jpg" alt="インフォメーション3の画像">
            </div>
          </div>
        </div>
      </div>
